var areaJson = function (level) {
    ...
    this.init = function () {
        myAjaxes(this.path + "area_first.json", function (ret) {

            self.oneList = ret;
        });

        if (self.level == 2) {
            myAjaxes(this.path + "area_second.json", function (ret) {
        ...
        if (self.level == 3) {
            myAjaxes(this.path + "area_three.json", function (ret) {
